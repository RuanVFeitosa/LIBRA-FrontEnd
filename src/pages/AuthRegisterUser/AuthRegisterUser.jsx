...
import { Link, useNavigate } from "react-router-dom"; // Importa a função para navegar

import "./AuthRegisterUser.css";
import mascote from "../../assets/LOOM.png";
// import libras from "../assets/libra.png";
// import VLibras from "@djpfs/react-vlibras";

function AuthRegisterUser() {
    ...
    return (
                ...
                <div className="wrapper">
                    <div className='formulario'>
                        <div className="title">
                            ...
                            <p className="login">Já possui cadastro? <span className='login-link'><Link to={"/auth/login"}>Faça login</Link></span></p>
                        </div>
        ...
        <Link to={"/auth/acessibilidade"}>TESTEE</Link>
            </div>
